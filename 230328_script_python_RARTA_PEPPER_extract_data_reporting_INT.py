...
os.chdir('/Users/clementine/Documents/TRAVAIL/PEPPER/RAR/Manip_Inserm/PHASE_1/interf')

#boucle pour appliquer le script dans tous les fichiers xlsx contenus dans le dossier # same as above
mydir = Path('/Users/clementine/Documents/TRAVAIL/PEPPER/RAR/Manip_Inserm/PHASE_1/interf')
...
#Importer la date du run, la molecule TOP, le mode, le numero du run
    ...
    df_id_top = pd.DataFrame(data_top, columns = ["Date", "Molecule", "Mode", "Run number", "Basal (%mean)", "Basal (%sd)", "Induction factor (mean)", "Induction factor (sd)", "", "", "Conc coexpo (M)"])
    ...
    df_id_bot = pd.DataFrame(data_bot, columns = ["Date", "Molecule", "Mode", "Run number", "Basal (%mean)", "Basal (%sd)", "Induction factor (mean)", "Induction factor (sd)", "", "", "Conc coexpo (M)"])
